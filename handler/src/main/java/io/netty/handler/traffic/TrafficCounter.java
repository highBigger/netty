 ...
 * <p>
 * It computes the statistics for both inoubnd and outbound traffic periodically at the givel
 * {@code checkInterval}, and calls back {@link AbstractTrafficShapingHandler#doAccounting(TrafficCounter)} method.
 * If the {@code checkInterval} is 0, no accounting will be done and statistics will only be computed at each
